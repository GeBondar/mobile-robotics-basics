...
В этих материалах разобраны:
- настройка локали;
- подключение официальных репозиториев ROS 2;
- установка базовых пакетов;
- первичная проверка работоспособности системы.

---

#### 2. Проверка установки и базовые команды ROS 2

👉 [`lesson_1/ros2_testing.md`](lesson_1/ros2_testing.md)

В рамках раздела:
- проверка окружения ROS 2;
- запуск демо-нод;
- знакомство с `ros2 run`, `ros2 node`, `ros2 topic`;
- понимание базовой логики взаимодействия нод.

---

#### 3. Моделирование мобильного робота в Turtlesim
...
#### 4. Визуальные инструменты ROS 2 (rqt)
