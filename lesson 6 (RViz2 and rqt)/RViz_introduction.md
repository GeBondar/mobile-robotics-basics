...
Этот инструмент позволяет установить начальную позу для инициализации системы локализации (отправляется в тему ROS `initialpose`). Щелкните по местоположению на наземной плоскости и перетащите, чтобы выбрать ориентацию. Выходная тема может быть изменена на панели **Tool Properties**.
...
Этот инструмент позволяет установить цель, отправляемую в тему ROS `goal_pose`. Щелкните по местоположению на наземной плоскости и перетащите, чтобы выбрать ориентацию. Выходная тема может быть изменена на панели **Tool Properties**.
