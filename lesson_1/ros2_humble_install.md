# Установка и проверка ROS 2 Humble на Ubuntu 22.04

Официальная инструкция: [ROS 2 Humble Installation Guide](https://docs.ros.org/en/humble/Installation/Ubuntu-Install-Debs.html)

## 📋 Предварительные требования

- **Операционная система:** Ubuntu 22.04 (Jammy Jellyfish)
- **Архитектура:** AMD64 (x86_64) или ARM64
- **Версия ROS:** Humble Hawksbill
...
- [Официальная документация ROS 2 Humble](https://docs.ros.org/en/humble/)
- [Туториалы для начинающих](https://docs.ros.org/en/humble/Tutorials/Beginner-CLI-Tools.html)
- [Примеры пакетов ROS 2](https://github.com/ros2/examples)
- [ROS 2 Community Answers](https://answers.ros.org/)
...
Выполните все команды последовательно для быстрой проверки:
    ...
    # Список запущенных узлов (должен быть пустым)
    ros2 node list
...
**Примечание:** Данная инструкция предназначена для чистой установки на Ubuntu 22.04. Если у вас возникают проблемы, проверьте [официальную документацию](https://docs.ros.org/en/humble/Installation.html) или обратитесь к сообществу ROS.
