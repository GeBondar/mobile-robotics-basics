...
Папка `action` будет содержать файлы описания действий, `scripts` — наши Python-узлы.
...
3. **Использование действий для планирования движения (move_base) в ROS2 Navigation.**
