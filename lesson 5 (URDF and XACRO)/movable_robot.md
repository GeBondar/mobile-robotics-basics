...
1.  Установлены все пакеты из предыдущего туториала "[Building a visual robot model](link_to_prev_urdf_tutorial)" (пакет `urdf_tutorial`).
...
![Окно с ползунками для управления суставами](images/joint_state_publisher_gui.png)
